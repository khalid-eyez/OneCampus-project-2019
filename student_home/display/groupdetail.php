                ...
                <div class="row" id="group_header_row">
                        ...
                        <div class="col-sm-9 col-md-9 col-lg-1 col-xl-1" id="grp_detail_desc_col">
                            ...
                            <div class="dropdown show" id="grp_detail_btn"><button class="btn dropdown-toggle" data-toggle="dropdown" aria-expanded="true" type="button">&nbsp;<i class="fas fa-ellipsis-v" id="grp_detail_btn_icon"></i></button>
                                <div class="dropdown-menu show" role="menu"><a class="dropdown-item" role="presentation" id="grp_detail_menu_add_user" href="#" onclick="addGroupMembers($(this).index())">Add user</a><a class="dropdown-item" role="presentation" id="grp_detail_menu_remove_grp" href="#">Remove group</a><a class="dropdown-item"
                                    ...
                                    while($row_for_grp_members = mysqli_fetch_assoc($result_for_grp_members))
                                    {
                                        ...
                                        <div id="group_members_div">
                                            <div class="row" id="group_members_div_row">
                                                <div class="col" id="group_members_img_col"><img id="group_members_img"src="display/assets/images/<?php echo $row_for_grp_members['group_icon'] ?>" onerror="this.src='display/assets/images/user_none.png'"></div>
