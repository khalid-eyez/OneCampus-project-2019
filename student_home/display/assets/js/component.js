$(document).ready(function() {
    ...
    $("#row-6-main-left-col").click(function() {
        $("#main").load("http://localhost/onecampus/Display/ForumList.php");
    });

    //Open Forum List from the Side bar Forum Button
    $("#replies-buttton").click(function() {
        $("#main").load("http://localhost/onecampus/Display/ForumChat.php");
    });

    //open new GroupList Page
    $("#row-5-main-left-col").click(function() {
        $("#main").load("./display/grouplist.php");
    });

    //open new GroupDetail Page
    openGroupDetail = function(index) {
        var group_id = $('#row_grp_list span').get(index).id;
        var mylink = "./display/groupdetail.php?groupid=" + group_id + "";
    ...
    addMembers = function() {
        $("#add_member_form").submit(function() {
            ...
            $("#group_right_col").load("./display/grouplist.php");
        });
    }
    ...
    openGroupMembers = function() {
        $("#create_grp_form").submit(function() {
            //Open Add Members Page
            $("#group_right_col").load("./display/groupmembers.php");
        });
    };
