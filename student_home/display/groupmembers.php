...
$query_for_member_id = "select student_bio.student_id,student_bio.firstname,student_bio.lastname,student_bio.profil from stud_partner,student_bio where (student_bio.student_id=stud_partner.student_id or student_bio.student_id=stud_partner.requester_id) && (stud_partner.student_id=$group_creator or stud_partner.requester_id=$group_creator) && stud_partner.status='accepted';";
...
<div class="row" id="grp_detail_page_num_row">
    ...
    <form id="add_member_form" method="post" action="./lib/AddGroupMembers.php">
                            ...
                            ?>
                                <ul id="username_list" onload="createMember()">
                                    <li class="user_li" id="username_li">
                                        <img class="rounded-circle" id="username_list_image" src="assets/img/profile.png">
