...
<div class="container" id="grp_container">
    <div class="row" id="group_row">
        <div class="col-sm-5 col-md-4 col-lg-4" id="group_left_col">
            ...
            <?php
                ...
                else
                {
                    ...
                    {    
                        ...
                        {
                            ?>
                            <div class="row" id="row_grp_list" onclick="openGroupDetail($(this).index())">
            ...
            ?>
        <i class="fa fa-plus-circle border rounded-circle" id="add_group_float_icon" onclick="openGroupCreate()"></i>
        </div>
