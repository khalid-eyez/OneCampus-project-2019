                                   ...
                                   $number_replies = mysqli_num_rows($result_replies)
                                    ...
                                    <div id="thread">
                                        <div class="row" id="thread-row">
                                            <div class="col" id="pfofile-img-col"><img class="rounded-circle" id="profile-img-thread" src="assets/img/man%20study.jpg"></div>
                                            ...
                                            <div class="col align-self-center" id="replies-buttton" onclick="location.href='Display/ForumChat.php?id=<?php echo $row_topic['th_id']; ?>';" style="cursor: pointer;">
                    ...
                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="http://localhost/onecampus/lib/Threads.php" method="post" name="NewThread" id="NewThread_Form">
                                        <h4 class="modal-title" id="Topic-Heading">Topic</h4>
                                            ...
                                            <span style='color:red' id="empty_topic"></span>
                                            <input type="hidden" id="user_id" name="user_id" value="<?php echo $_SESSION["user_id"];?>">

                                        <h4 id="Message-Heading">Message</h4>
                                        <textarea id="Message-TextArea" name="message"></textarea>
                                        <span style='color:red' id="empty_message"></span>
                                    </div>
