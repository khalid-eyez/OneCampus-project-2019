...
if(isset($_POST['login']))
{
    ...
    $sql ="SELECT uname,password,level FROM admin WHERE uname=:your_name and Password=:password";
    ...
    if($query->rowCount() > 0)
    {
        ...
        $sql2 = "SELECT uname,password,level FROM admin WHERE uname=:your_name and Password=:password";
