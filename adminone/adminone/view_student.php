					...
					<ul class="nav nav-primary">
						...
						<li class="nav-item">
							...
							<div class="collapse" id="uploader">
								<ul class="nav nav-collapse">
									<li>
										<a href="add_uploader.php">
											<span class="sub-item">Add Uploader</span>
										</a>
									</li>
									<li>
										<a href="view_uploader.php">
											<span class="sub-item">View Uploader</span>
										</a>
									</li>
								</ul>
							</div>
								...
								<ul class="nav nav-collapse">
									<li>
										<a href="add_student.php">
											<span class="sub-item">Add Subscriber</span>
										</a>
									</li>
									<li>
										<a href="view_student.php">
											<span class="sub-item">View Subscriber</span>
										</a>
									</li>
								</ul>
							</div>
								...
								<ul class="nav nav-collapse">
									<li>
										<a href="add_course.php">
											<span class="sub-item">Course Register</span>
										</a>
									</li>
									<li>
										<a href="view_course.php">
											<span class="sub-item">View Register</span>
										</a>
									</li>
								</ul>
							</div>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title">Student Registered</h4>
								...
								<div class="table-responsive">
										...
										<?php $sql = "SELECT * from  student order by id desc";
                                        $query = $dbh -> prepare($sql);
                                        $query->execute();
                                        ...
                                        if($query->rowCount() > 0)
                                        {
                                            foreach($results as $result)
												...
												<tr>
													...
													<td><?php echo htmlentities($result->from_valid);?></td>
													<td><?php echo htmlentities($result->to_valid);?></td>
													<td><?php echo htmlentities($result->status);?></td>
													<td>
														<div class="form-button-action">
															<a href="view_student.php?del=<?php echo $result->id;?>" onclick="return confirm('Do you want to Delete');">
