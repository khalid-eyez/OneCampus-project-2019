							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title">View Replies</h4>
								...
								<div class="table-responsive">
										...
										<?php $sql = "SELECT * from    replies order by rep_id desc";
                                        $query = $dbh -> prepare($sql);
                                        $query->execute();
                                        ...
                                        if($query->rowCount() > 0)
                                        {
                                            foreach($results as $result)
												...
												<tr>
													...
													<td><?php echo htmlentities($result->th_id);?></td>
													<td><?php echo htmlentities($result->student_id);?></td>
													<td><?php echo htmlentities($result->mat_id);?></td>
													<td><?php echo htmlentities($result->rep_content);?></td>
													<td><?php echo htmlentities($result->rep_date);?></td>
													<td>
														<div class="form-button-action">
															<a href="view_replies.php?del=<?php echo $result->rep_id;?>" onclick="return confirm('Do you want to Delete');">
