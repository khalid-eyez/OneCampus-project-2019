						...
						<div class="col-md-12">
							<div class="card">
								...
								<div class="table-responsive">
										...
										<?php $sql = "SELECT * from   group_member order by gmember_id desc";
                                        $query = $dbh -> prepare($sql);
                                        $query->execute();
                                        ...
                                        if($query->rowCount() > 0)
                                        {
                                            foreach($results as $result)
												...
												<tr>
													...
													<td><?php echo htmlentities($result->group_idIndex);?></td>
													<td><?php echo htmlentities($result->student_id);?></td>
													<td><?php echo htmlentities($result->membertime);?></td>
													<td>
														<div class="form-button-action">
																<a href="view_group_member.php?del=<?php echo $result->gmember_id;?>" onclick="return confirm('Do you want to Delete');">
