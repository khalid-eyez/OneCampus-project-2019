...
{   
    ...
    {
        $id=$_GET['del'];
        $sql = "DELETE FROM `group_shares` WHERE `group_shares`.`share_id` = $id";
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title">Group Share</h4>
								...
								<div class="table-responsive">
										...
										<?php $sql = "SELECT * from    group_shares order by share_id desc";
                                        $query = $dbh -> prepare($sql);
                                        $query->execute();
                                        ...
                                        if($query->rowCount() > 0)
                                        {
                                            foreach($results as $result)
												...
												<tr>
													...
													<td><?php echo htmlentities($result->sharedate);?></td>
													<td>
														<div class="form-button-action">
															<a href="view_group_member.php?del=<?php echo $result->share_id;?>" onclick="return confirm('Do you want to Delete');">
