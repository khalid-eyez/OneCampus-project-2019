...
{   
    ...
    {
        $id=$_GET['del'];
        $sql = "DELETE FROM `group_member` WHERE `group_member`.`gmember_id` = $id";
						...
						<div class="col-md-12">
							<div class="card">
								...
								<div class="table-responsive">
										...
										<?php $sql = "SELECT * from    notification order by not_id desc";
                                        $query = $dbh -> prepare($sql);
                                        $query->execute();
                                        ...
                                        if($query->rowCount() > 0)
                                        {
                                            foreach($results as $result)
												...
												<tr>
													...
													<td><?php echo htmlentities($result->not_type);?></td>
													<td><?php echo htmlentities($result->not_content);?></td>
													<td><?php echo htmlentities($result->created_date);?></td>
													<td>
														<div class="form-button-action">
															<a href="view_notification.php?del=<?php echo $result->not_id;?>" onclick="return confirm('Do you want to Delete');">
