...
{   
    ...
    {
        $id=$_GET['del'];
        $sql = "DELETE FROM `student_academics` WHERE `student_academics`.`school_id` = $id";
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title">Student Academic</h4>
								...
								<div class="table-responsive">
										...
										<?php $sql = "SELECT * from   student_academics order by school_id desc";
                                        $query = $dbh -> prepare($sql);
                                        $query->execute();
                                        ...
                                        if($query->rowCount() > 0)
                                        {
                                            foreach($results as $result)
												...
												<tr>
													...
													<td><?php echo htmlentities($result->FOS);?></td>
													<td><?php echo htmlentities($result->P_title);?></td>
													<td><?php echo htmlentities($result->duration);?></td>
													<td><?php echo htmlentities($result->YOS);?></td>
													<td>
														<div class="form-button-action">
															<a href="view_student_accademic.php?del=<?php echo $result->school_id;?>" onclick="return confirm('Do you want to Delete');">
