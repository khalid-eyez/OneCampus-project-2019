...
{   
    ...
    {
        $id=$_GET['del'];
        $sql = "DELETE FROM `stud_partner` WHERE `stud_partner`.`part_id` = $id";
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title">View Partners</h4>
								...
								<div class="table-responsive">
										...
										<?php $sql = "SELECT * from    stud_partner order by part_id desc";
                                        $query = $dbh -> prepare($sql);
                                        $query->execute();
                                        ...
                                        if($query->rowCount() > 0)
                                        {
                                            foreach($results as $result)
												...
												<tr>
													...
													<td><?php echo htmlentities($result->requester_id);?></td>
													<td><?php echo htmlentities($result->student_id);?></td>
													<td><?php echo htmlentities($result->status);?></td>
													<td><?php echo htmlentities($result->requesttime);?></td>
													<td><?php echo htmlentities($result->accepttime);?></td>
													<td>
														<div class="form-button-action">
															<a href="view_parteners.php?del=<?php echo $result->part_id;?>" onclick="return confirm('Do you want to Delete');">
