...
{   
    ...
    {
        $id=$_GET['del'];
        $sql = "DELETE FROM `group_session` WHERE `group_session`.`session_id` = $id";
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title">Group Session</h4>
								...
								<div class="table-responsive">
										...
										<?php $sql = "SELECT * from   group_session order by session_id desc";
                                        $query = $dbh -> prepare($sql);
                                        $query->execute();
                                        ...
                                        if($query->rowCount() > 0)
                                        {
                                            foreach($results as $result)
												...
												<tr>
													...
													<td><?php echo htmlentities($result->session_title);?></td>
													...
													<td><?php echo htmlentities($result->finish_time);?></td>
													<td><?php echo htmlentities($result->rotate_method);?></td>
													<td><?php echo htmlentities($result->status);?></td>
													<td>
														<div class="form-button-action">
														<a href="view_group_session.php?del=<?php echo $result->session_id;?>" onclick="return confirm('Do you want to Delete');">
