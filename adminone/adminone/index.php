		...
		<div class="main-panel">
			...
			<div class="content">
				<div class="page-inner">
					<!-- Card -->
					<h4 class="page-title">Statistics Data</h4>
					<div class="row">
							...
							<div class="card card-stats card-info card-round">
								<div class="card-body">
									<div class="row">
										...
										<div class="col-7 col-stats">
											<div class="numbers">
												<p class="card-category">College</p>
												<h4 class="card-title">133</h4>
											</div>
										</div>
									</div>
								</div>
			...
			<footer class="footer">
				<div class="container-fluid">
					...
					<div class="copyright ml-auto">
						2020, made with <i class="fa fa-heart heart text-danger"></i> by <a href="https://www.instagram.com/isofttz">iSoftTz</a>
					</div>				
				</div>
			</footer>
		</div>
