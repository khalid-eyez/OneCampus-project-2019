							...
							<li class="nav-item">
								...
								<div class="collapse" id="forms">
									<ul class="nav nav-collapse">
										...
										<li>
											<a href="view_study_notification.php">
												<span class="sub-item">Study Notification</span>
											</a>
										</li>
										<li>
								...
								<div class="card">
									<div class="card-header">
										<div class="d-flex align-items-center">
											<h4 class="card-title">Group Registered</h4>
									...
									<div class="table-responsive">
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<tbody>
												...
												<?php $sql = "SELECT * from  groups order by group_id desc";
												$query = $dbh -> prepare($sql);
												$query->execute();
												...
												if($query->rowCount() > 0)
												{
													...
													<tr>
														...
														<td><?php echo htmlentities($result->group_name);?></td>
														<td><?php echo htmlentities($result->group_icon);?></td>
														<td><?php echo htmlentities($result->group_desc);?></td>
														<td><?php echo htmlentities($result->createdate);?></td>
														<td>
															<div class="form-button-action">
																<a href="view_groups.php?del=<?php echo $result->group_id;?>&name=<?php echo htmlentities($result->email);?>" onclick="return confirm('Do you want to Delete Group');">
				...
				<footer class="footer">
					<div class="container-fluid">
						<nav class="pull-left">
							<ul class="nav">
								<li class="nav-item">
									<a class="nav-link" href="https://www.School System.com">
										Admin OneCampus
									</a>
								</li>
								<li class="nav-item">
