...
{   
    ...
    {
        $id=$_GET['del'];
        $sql = "DELETE FROM `student_account` WHERE `student_account`.`acc_id` = $id";
						...
						<div class="col-md-12">
							<div class="card">
								...
								<div class="table-responsive">
										...
										<?php $sql = "SELECT * from   student_account order by acc_id desc";
                                        $query = $dbh -> prepare($sql);
                                        $query->execute();
                                        ...
                                        if($query->rowCount() > 0)
                                        {
                                            foreach($results as $result)
												...
												<tr>
													...
													<td><?php echo htmlentities($result->acc_status);?></td>
													<td>
														<div class="form-button-action">
																<a href="view_student_account.php?del=<?php echo $result->acc_id;?>" onclick="return confirm('Do you want to Delete');">
