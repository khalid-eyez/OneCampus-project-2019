							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title">Study Field</h4>
								...
								<div class="table-responsive">
										...
										<?php $sql = "SELECT * from study_subject order by sub_id desc";
                                        $query = $dbh -> prepare($sql);
                                        $query->execute();
                                        ...
                                        if($query->rowCount() > 0)
                                        {
                                            foreach($results as $result)
												...
												<tr>
													...
													<td><?php echo htmlentities($result->fi_id);?></td>
													<td><?php echo htmlentities($result->sub_title);?></td>
													<td>
